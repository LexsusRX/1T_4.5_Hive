...
**Выполнение**
- В файле "scrin_result_table.png" скрин итоговой витрины
- В файле "scrin_script_in_hive.png" скрин запуска скрипта
- SQL_Hive_scripts.sql -- скрипт для выполнения запроса в Hive
- Change_files.py -- скрипт на Pyton для изменения итсходных файлов (в Git загружены только конечный вариант файлов)
